...
const {   getHomePage, getPlansPage, getLoginPage, getProfilePage ,getReviewpage, getSignupPage,getForgetPasswordPage,getResetPage,getSomethingWentWrong} = require("../controller/viewController");
...
viewRouter.get("/reviews",protectRoute,getReviewpage);
